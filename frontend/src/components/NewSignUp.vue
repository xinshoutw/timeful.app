    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div class="tw-mb-2 tw-text-lg tw-text-black">
            哪些{{ selectedDateOption === dateOptions.SPECIFIC ? "時段" : "天" }}可能可以？
          </div>
          <v-select
            v-if="!edit && !daysOnly"
